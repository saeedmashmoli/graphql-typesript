...
export type MessageSnippetFragment = (
  ...
  & { sender: (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'name' | 'mobile'>
  ) }
);

export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'id' | 'createdAt' | 'updatedAt' | 'title' | 'points' | 'body' | 'bodySnippet' | 'voteStatus'>
  & { creator: (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'name' | 'mobile'>
  ) }
...
export type RegularUserFragment = (
  { __typename?: 'User' }
  & Pick<User, 'id' | 'name' | 'email' | 'mobile'>
);
...
export type CreatePostMutation = (
  ...
  & { createPost: (
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'createdAt' | 'updatedAt' | 'title' | 'body' | 'points' | 'creatorId'>
  ) }
);
...
export const RegisterDocument = gql`
    mutation register($name: String!, $mobile: String!, $email: String!, $password: String!) {
  register(
    password: $password
    options: {name: $name, mobile: $mobile, email: $email}
  ) {
    ...RegularUserResponse
  }
}
...
export function useMessageQuery(baseOptions: Apollo.QueryHookOptions<MessageQuery, MessageQueryVariables>) {
        return Apollo.useQuery<MessageQuery, MessageQueryVariables>(MessageDocument, baseOptions);
      }
export function useMessageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MessageQuery, MessageQueryVariables>) {
          return Apollo.useLazyQuery<MessageQuery, MessageQueryVariables>(MessageDocument, baseOptions);
        }

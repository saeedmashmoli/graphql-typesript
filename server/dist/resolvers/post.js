...
let PostResolver = class PostResolver {
    bodySnippet(root) { return root.body.slice(0, 50); }
    creator(post, { userLoader }) { return userLoader.load(post.creatorId); }
    ...
    posts(limit, cursor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const replacements = [plusRealLimit];
            let cursorInx = 3;
            if (cursor) {
    ...
    createPost(input, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield Post_1.Post.create(Object.assign(Object.assign({}, input), { creatorId })).save();
        });
    }
    updatePost(id, body, title, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
